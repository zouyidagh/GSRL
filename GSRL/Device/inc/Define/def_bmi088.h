...
#ifndef __DEF_BMI088_H
#define __DEF_BMI088_H
...
#define BMI088_GYRO_BANDWIDTH_MUST_Set 0x80 // the first num means Output data  rate, the second num means bandwidth
