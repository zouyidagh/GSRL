...
if(ARM_GCC_PATH)
    ...
    string(REPLACE "/" "${CONFIG_PATH_SEP}" CONFIG_TOOLCHAIN_BIN_DIR_NATIVE "${CONFIG_TOOLCHAIN_BIN_DIR}")
    set(CONFIG_QUERY_DRIVER "${CONFIG_TOOLCHAIN_BIN_DIR_NATIVE}${CONFIG_PATH_SEP}${CONFIG_TOOLCHAIN_PREFIX}*")
else()
